...
public class CompraPieza {
	JFrame ventana;
	public CompraPieza() {
		ventana = new JFrame("Solicitar compra");
		JPanel panel = new JPanel(new GridLayout(11, 2));
		
		URL urlLogo = Consola.class.getResource("/interfaz/ImagenesInterfaz/logo.png");
    	ImageIcon logo = new ImageIcon(urlLogo);
    	
    	URL urlRegistrarEmpleado = Consola.class.getResource("/interfaz/ImagenesInterfaz/solicitar_compra.png");
		...
		for (int i = 1; i <= 22; i++) {
			...
			case 5:
				...
				componente = new JLabel("Solicitar compra de pieza");
			...
			case 7:
				...
				break;
			case 9:
				componente =  new JButton("Comprar");
				break;
			default:
