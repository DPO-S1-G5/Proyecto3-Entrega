...
public class Subastas {
	public Subastas() {
		JFrame ventana = new JFrame("Subastas");
        ...
        for (int i = 1; i <= 20; i++) {
			...
			case 1:
				...
				componenteAniadir = new JLabel("Ver solicitudes de ingreso a subasta");
				...
				componenteEliminar = new JLabel("Aprobar solicitudes de ingreso a subasta");
