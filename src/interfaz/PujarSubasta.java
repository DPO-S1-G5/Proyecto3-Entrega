...
public class PujarSubasta {
	JFrame ventana;
	public PujarSubasta() {
		ventana = new JFrame("Pujar en subasta");
		JPanel panel = new JPanel(new GridLayout(11, 2));
		
		URL urlLogo = Consola.class.getResource("/interfaz/ImagenesInterfaz/logo.png");
    	ImageIcon logo = new ImageIcon(urlLogo);
    	
    	URL urlRegistrarEmpleado = Consola.class.getResource("/interfaz/ImagenesInterfaz/pujar_en_subasta.png");
		...
		for (int i = 1; i <= 22; i++) {
			...
			case 5:
				...
				componente = new JLabel("Pujar en subasta");
			...
			case 7:
				...
				break;
			case 9:
				componente =  new JTextField("Monto a pujar");
				break;
				
			case 11:
				componente =  new JButton("Pujar");
				break;
			default:
