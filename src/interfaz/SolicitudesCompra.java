...
public class SolicitudesCompra {
	public SolicitudesCompra() {
		JFrame ventana = new JFrame("Solicitudes compra");
        ...
        for (int i = 1; i <= 20; i++) {
			...
			case 1:
				...
				componenteAniadir = new JLabel("Ver solicitudes de compra");
				...
				componenteEliminar = new JLabel("Aprobar solicitudes de compra");
