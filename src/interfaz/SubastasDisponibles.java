...
public class SubastasDisponibles {
	JFrame ventana;
	public SubastasDisponibles() {
		ventana = new JFrame("Subastas disponibles");
		JPanel panel = new JPanel(new GridLayout(11, 2));
		
		URL urlLogo = Consola.class.getResource("/interfaz/ImagenesInterfaz/logo.png");
    	ImageIcon logo = new ImageIcon(urlLogo);
    	URL urlRegistrarEmpleado = Consola.class.getResource("/interfaz/ImagenesInterfaz/subastas_disponibles.png");
		...
		for (int i = 1; i <= 22; i++) {
			...
			case 5:
				...
				componente = new JLabel("Subastas:");
				componente.setFont(fontLabelR);
				componente.setBackground(Color.DARK_GRAY);
				break;
			case 7:
				componente =  new JLabel("Id subasta");
				break;
			case 8:
				componente =  new JButton("Subasta");
